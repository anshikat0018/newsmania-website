...
import { Bookmark, ArrowRight, Loader, Search } from "lucide-react";
...
export default function Saved() {
  ...
  const fetchSaved = useCallback(async (pageNum = 1) => {
    try {
      ...
      const response = await api.get(`web/blogs/saved/list?${params.toString()}`);
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="flex items-center gap-2 pt-2 pb-1 border-b border-gray-100">
        <Bookmark size={15} className="text-black-500 fill-black" />
