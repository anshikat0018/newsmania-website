...
import { Bookmark, ArrowRight, Loader, Heart } from "lucide-react";
...
export default function Liked() {
  ...
  const fetchLiked = useCallback(async (pageNum = 1) => {
    try {
      setIsFetching(true);
      ...
      const response = await api.get(`web/blogs/liked/list?${params.toString()}`);
  ...
  if (!loading && blogs.length === 0) return (
    <div className="flex flex-col items-center justify-center min-h-[65vh] text-center px-4">
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-2">No liked items yet</h2>
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="flex items-center gap-2 pt-2 pb-1 border-b border-gray-100">
        <Heart size={15} className="text-red-500 fill-red-400" />
